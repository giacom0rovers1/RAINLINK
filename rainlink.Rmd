...
# PolyGrid <- PolyGridGen(IntpGrid = RainGrid, SaveToFile = TRUE)
...
save(RainFields, file = "IntpRainFields_ER2016.RData")  # ~ 240 s
...
# Carico i confini di provincia
shapefilename  <- "/home/giacomo/Projects/Rainlink4EMR/scripts/init_scripts/interpolation_grid/clippingZoneUtility/kml/PARMA.kml"
parma.border   <- readOGR(shapefilename)
shapefilename  <- "/home/giacomo/Projects/Rainlink4EMR/scripts/init_scripts/interpolation_grid/clippingZoneUtility/kml/BOLOGNA.kml"
bologna.border <- readOGR(shapefilename)
...
save(RainMaps, file = "IntpRainMaps_ER2016.RData")
